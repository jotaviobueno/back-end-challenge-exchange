...
ClientRoutes.patch("/change-password", UpdateRequest.ValidateUpdatePassword, UpdateController.UpdatePassword);
ClientRoutes.patch("/change-email", UpdateRequest.ValidateUpdateEmail, UpdateController.UpdateEmail);
